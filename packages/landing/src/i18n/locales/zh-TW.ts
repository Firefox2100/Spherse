...
export const zhTW: Record<keyof typeof zhCN, string> = {
  ...
  "hero.linuxTip": "Linux 版為 AppImage 格式，下載後需先賦予可執行權限再執行（終端機執行 chmod +x Spherse-*.AppImage，或在檔案管理員屬性中勾選「允許作為程式執行」）。Ubuntu 23.10 及以上版本若啟動時報 SUID sandbox 錯誤，請先執行 sudo sysctl -k kernel.apparmor_restrict_unprivileged_userns=0 後重試；deb 安裝包可前往 GitHub Releases 下載。",
